...
function SpecStudentAssignment(){
    const{specStudent,class_name}=useParams()
    ...
    useEffect(()=>{
        // console.log(`/${metaInfo.subId}/answers/${class_name}/${metaInfo.studId}/${specStudent}`)
        ...
        <>
            <div id="removeColor">
                ...
                <div className="testing">
                    <iframe src={`/${metaInfo.subId}/answers/${class_name}/${metaInfo.studId}/${specStudent}`}></iframe>                                    
                </div>
            </div>
        </>
    )
